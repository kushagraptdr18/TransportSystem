...
const firmSchema = z.object({
  ...
  ibaCode: z.string().nullish(),
  vendorCode: z.string().nullish(),
  rcmCovered: z.boolean().default(true),
  ...
  podFollowUpDays: z.number().int().min(1).max(90).default(15),
