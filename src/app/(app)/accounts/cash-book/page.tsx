...
export default async function CashBookPage({
  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <SimpleReport
        title={searchParams.party ? "Running balance shown for selected account" : "Select a cash account to see running balance"}
        columns={BOOK_COLUMNS}
        rows={rows}
        fileName="cash-book"
        emptyMessage="No cash entries in this period."
      />
    </div>
  );
}
